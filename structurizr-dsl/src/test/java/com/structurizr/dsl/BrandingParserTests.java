...
class BrandingParserTests extends AbstractTests {
    ...
    void test_parseLogo_ThrowsAnException_WhenTheFileIsNotSupported() {
        ...
        try {
            parser.parseLogo(context, tokens("logo", "src/test/resources/dsl/getting-started.dsl"), false);
            fail();
        } catch (Exception e) {
            e.printStackTrace();
    ...
    void test_parseLogo_SetsTheLogo_WhenTheLogoDoesExist() {
        ...
        parser.parseLogo(context, tokens("logo", "src/test/resources/dsl/logo.png"), false);
