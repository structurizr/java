...
public class TestConstants {
    ...
    public static final String MY_APP_TEST_PACKAGE_TO_SCAN = "com.structurizr.testapp.myapp";
    ...
    public static final String MATCH_ALL_UNDER_MYAPP_PACKAGE_REGEX = ".*\\.myapp\\..*";
