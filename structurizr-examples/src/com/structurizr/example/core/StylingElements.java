...
/**
 * An example of how to style diagram elements.
 *
...
public class StylingElements {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // create a model to describe a user using a software system, which itself
        // is made up of a web application talking to a database
