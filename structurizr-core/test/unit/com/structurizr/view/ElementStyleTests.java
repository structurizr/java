...
public class ElementStyleTests {
    ...
    @Test
    void test_setBackground_SetsTheBackgroundProperty_WhenAValidHexColorCodeIsSpecified() {
        ElementStyle style = new ElementStyle();
    ...
    @Test
    void test_setBackground_ThrowsAnException_WhenAnInvalidHexColorCodeIsSpecified() {
        assertThrows(IllegalArgumentException.class, () -> {
            ElementStyle style = new ElementStyle();
    ...
    @Test
    void test_background_ThrowsAnException_WhenAnInvalidHexColorCodeIsSpecified() {
        assertThrows(IllegalArgumentException.class, () -> {
            ElementStyle style = new ElementStyle();
    ...
    @Test
    void test_setIcon_ThrowsAnIllegalArgumentException_WhenAnInvalidUrlIsSpecified() {
        assertThrows(IllegalArgumentException.class, () -> {
            ElementStyle style = new ElementStyle();
    ...
    @Test
    void test_setStroke_ThrowsAnException_WhenAnInvalidHexColorCodeIsSpecified() {
        assertThrows(IllegalArgumentException.class, () -> {
            ElementStyle style = new ElementStyle();
    ...
    @Test
    void test_Stroke_ThrowsAnException_WhenAnInvalidHexColorCodeIsSpecified() {
        assertThrows(IllegalArgumentException.class, () -> {
            ElementStyle style = new ElementStyle();
            style.stroke("white");
        });
