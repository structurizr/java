...
public class JsonTests {
    ...
    protected Workspace createWorkspace() {
        ...
        views.getConfiguration().getStyles().add(new RelationshipStyle(Tags.RELATIONSHIP, 4, "#dddddd", true, 25, 300, null));
        views.getConfiguration().getStyles().add(new RelationshipStyle("JDBC", 4, "#ff0000", true, 25, 300, null));
