...
public class StructurizrDocumentationTests {
    ...
    public void test_addAllSectionsWithContentAsStrings() {
        ...
        assertSection(softwareSystem, "Context", Format.Markdown, "Context section", 1, section, documentation);

        section = documentation.addFunctionalOverviewSection(softwareSystem, Format.Markdown, "Functional overview section");
        assertSection(softwareSystem, "Functional Overview", Format.Markdown, "Functional overview section", 2, section, documentation);

        section = documentation.addQualityAttributesSection(softwareSystem, Format.Markdown, "Quality attributes section");
        assertSection(softwareSystem, "Quality Attributes", Format.Markdown, "Quality attributes section", 3, section, documentation);

        section = documentation.addConstraintsSection(softwareSystem, Format.Markdown, "Constraints section");
        assertSection(softwareSystem, "Constraints", Format.Markdown, "Constraints section", 4, section, documentation);

        section = documentation.addPrinciplesSection(softwareSystem, Format.Markdown, "Principles section");
        assertSection(softwareSystem, "Principles", Format.Markdown, "Principles section", 5, section, documentation);

        section = documentation.addSoftwareArchitectureSection(softwareSystem, Format.Markdown, "Software architecture section");
        assertSection(softwareSystem, "Software Architecture", Format.Markdown, "Software architecture section", 6, section, documentation);

        section = documentation.addContainersSection(softwareSystem, Format.Markdown, "Containers section");
        assertSection(softwareSystem, "Containers", Format.Markdown, "Containers section", 7, section, documentation);

        section = documentation.addComponentsSection(containerA, Format.Markdown, "Components section for container A");
        assertSection(containerA, "Components", Format.Markdown, "Components section for container A", 8, section, documentation);

        section = documentation.addComponentsSection(containerB, Format.Markdown, "Components section for container B");
        assertSection(containerB, "Components", Format.Markdown, "Components section for container B", 9, section, documentation);

        section = documentation.addCodeSection(componentA1, Format.Markdown, "Code section for component A1");
        assertSection(componentA1, "Code", Format.Markdown, "Code section for component A1", 10, section, documentation);

        section = documentation.addCodeSection(componentA2, Format.Markdown, "Code section for component A2");
        assertSection(componentA2, "Code", Format.Markdown, "Code section for component A2", 11, section, documentation);

        section = documentation.addDataSection(softwareSystem, Format.Markdown, "Data section");
        assertSection(softwareSystem, "Data", Format.Markdown, "Data section", 12, section, documentation);
        ...
        assertSection(softwareSystem, "Infrastructure Architecture", Format.Markdown, "Infrastructure architecture section", 13, section, documentation);

        section = documentation.addDeploymentSection(softwareSystem, Format.Markdown, "Deployment section");
        assertSection(softwareSystem, "Deployment", Format.Markdown, "Deployment section", 14, section, documentation);

        section = documentation.addDevelopmentEnvironmentSection(softwareSystem, Format.Markdown, "Development environment section");
        assertSection(softwareSystem, "Development Environment", Format.Markdown, "Development environment section", 15, section, documentation);

        section = documentation.addOperationAndSupportSection(softwareSystem, Format.Markdown, "Operation and support section");
        assertSection(softwareSystem, "Operation And Support", Format.Markdown, "Operation and support section", 16, section, documentation);

        section = documentation.addDecisionLog(softwareSystem, Format.Markdown, "Decision log section");
        assertSection(softwareSystem, "Decision Log", Format.Markdown, "Decision log section", 17, section, documentation);
    }
