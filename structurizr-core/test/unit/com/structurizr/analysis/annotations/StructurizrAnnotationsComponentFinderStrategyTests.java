...
public class StructurizrAnnotationsComponentFinderStrategyTests {
    ...
    public void setUp() throws Exception {
        ...
        ComponentFinder componentFinder = new ComponentFinder(
                webApplication,
                "com.structurizr.analysis.annotations",
    ...
    public void test_ThereAreFiveComponents() {
        ...
        assertEquals("com.structurizr.analysis.annotations.controller.html.MyHtmlController", myHtmlController.getType());
        ...
        assertEquals("com.structurizr.analysis.annotations.controller.json.MyJsonController", myJsonController.getType());
        ...
        assertEquals("com.structurizr.analysis.annotations.service.MyService", myService.getType());
        assertEquals("A component that does some business logic", myService.getDescription());
        assertEquals(2, myService.getCode().size());
        assertCodeElementInComponent(myService, "com.structurizr.analysis.annotations.service.MyService", CodeElementRole.Primary);
        assertCodeElementInComponent(myService, "com.structurizr.analysis.annotations.service.MyServiceImpl", CodeElementRole.Supporting);
        ...
        assertEquals("com.structurizr.analysis.annotations.repository.MyRepository", myRepository.getType());
        assertEquals("Manages some data", myRepository.getDescription());
        assertEquals(2, myRepository.getCode().size());
        assertCodeElementInComponent(myRepository, "com.structurizr.analysis.annotations.repository.MyRepository", CodeElementRole.Primary);
        assertCodeElementInComponent(myRepository, "com.structurizr.analysis.annotations.repository.MyRepositoryImpl", CodeElementRole.Supporting);
        ...
        assertEquals("com.structurizr.analysis.annotations.logging.LoggingComponent", loggingComponent.getType());
        ...
        assertCodeElementInComponent(loggingComponent, "com.structurizr.analysis.annotations.logging.LoggingComponent", CodeElementRole.Primary);
        assertCodeElementInComponent(loggingComponent, "com.structurizr.analysis.annotations.logging.LoggingComponentImpl", CodeElementRole.Supporting);
    }
